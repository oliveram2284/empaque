		...
		if(mysql_num_rows($resu) >  0)
			{
				...
				echo '<img src="assest/plugins/buttons/icons/page_white_acrobat.png" title="Imprimir Pedido" onClick="ValidarExportacion()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
				echo '<img src="assest/plugins/buttons/icons/icono_excel.gif" title="Exportar a Exel" onClick="ExportarAExcel()">';
