...
<div class="modal hide fade" id="modal_Notas">
  ...
  <input type="hidden" id="Leido_">
	<div class="row">
		...
		<div class="span2 offset1"><div id="error_nota" class="alert alert-danger" role="alert" style="display: none;"><center><b>¡Error!</b></center></div></div>
	</div>
	<div class="row">
