...
header("Content-Disposition: attachment; filename=reportedepedidos.xls");
	 ...
	 //echo $sql;
		...
		if(mysql_num_rows($resu) >  0)
			{				
				...
				echo '<strong>Cantidad de Pedidos: <span style="color:red; font-size: 20px;">'.mysql_num_rows($resu).'</span></strong>';
				...
				<th style=\"text-align: center;\" width=\"270px;\">Art&eacute;culo</th>
				<th style=\"text-align: center;\" width=\"80px;\">Fecha Emisi&oacute;n</th>
