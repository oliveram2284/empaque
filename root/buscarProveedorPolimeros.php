<?php
	...
	$consulta = "Select * from proveedores limit 0,10";
...
<br><br>
<label>Buscar: &nbsp;&nbsp;</label>
<input type="text" id="buscador" name="buscador" size="60" onKeyUp="ajaxx(this.value,'div_find','buscarProveedorPolimerosAjax.php',LimiteMenor.value, LimiteMayor.value, 0)"/>
...
<?php
$pagina = 10;
		echo '<dir><input type="button" value="<<" onClick="ajaxx(buscador.value,\'div_find\',\'buscarProveedorPolimerosAjax.php\', 0,10, 0)">&nbsp;';
		...
		echo'<input type="button" value=">>" onClick="ajaxx(buscador.value,\'div_find\',\'buscarProveedorPolimerosAjax.php\', '.$pagina.','.$pagina.', 0)">&nbsp;';
