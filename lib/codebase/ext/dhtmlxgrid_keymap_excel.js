...
dhtmlXGridObject.prototype._key_events={k13_1_0:function(){this.editStop()},
 ...
 if (this.cell){var c=this.cells4(this.cell);if (c.isDisabled()) return false;var t=c.getValue();c.setValue("");this.editCell();if (this.editor){this.editor.val=t;if (this.editor.obj && this.editor.obj.select)this.editor.obj.select()}else c.setValue(t)}}};
//v.2.5 build 090904
