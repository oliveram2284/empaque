...
//			if( $estado == "N")
//			{
//				echo '<script>alert("Pedido pasado a estado de Dise�o.");location.href="principal.php";</script>';
//			}
//			else
//			{
//				echo '<script>alert("Pedido pasado a estado de Producci�n.");location.href="principal.php";</script>';
//			}
//			break;
//	 case "V":
//	 		//modificar encabezado de pedido
...
//	
//	case "D":
//			$consulta = "Update pedidos Set estado ='D', version=(version+1) Where npedido=$id"; // Aca agregar versi�n
//			$resu = mysql_query($consulta);
//			
//			reg_log($id, $accion);
//				
